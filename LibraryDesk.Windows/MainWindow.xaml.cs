...
{
    private const string HomeUrl = "https://www.iranpl.ir/";
    ...
    public MainWindow()
    {
        ...
        Loaded += async (_, _) =>
        {
            ...
            {
                StatusText.Text = "WebView2 Runtime نصب نیست: " + ex.Message;
            }
        };
    }
    ...
    private void Shortcut_Click(object sender, RoutedEventArgs e) => Navigate((sender as Button)?.Tag?.ToString());
